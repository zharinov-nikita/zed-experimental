...
- [ ] Тесты сериализации Quote Reply Block и подписи crease (короткий и длинный комментарий).
- [ ] Тесты хоста: пункт и хоткей погашены при активной сессии и без выделения; Discard пустого комментария удаляет блок.
- [ ] Ручная проверка: диктовка с плашкой цитаты, Resume добавляет к комментарию, цитата неизменна, отправка агенту.
